...
use App\Http\Controllers\API\DosenPengujiController;
...
// Dosen Penguji API
Route::prefix('dosen-penguji')->middleware('auth:sanctum')->name('dosen-penguji.')->group(function(){
    Route::get('', [DosenPengujiController::class, 'index'])->name('index');
    Route::get('{id}', [DosenPengujiController::class, 'show'])->name('show');
    Route::post('', [DosenPengujiController::class, 'store'])->name('store');
    Route::put('{id}', [DosenPengujiController::class, 'update'])->name('update');
    Route::delete('{id}', [DosenPengujiController::class, 'destroy'])->name('destroy');
});
