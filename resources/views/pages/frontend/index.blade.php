        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member d-flex align-items-start justify-content-center">
                            <div class="pic"><img src="{{ asset('frontend/assets/img/team/andi1.png') }}" class="img-fluid" alt="">
                                <div class="member-info">
                                    <h4>Andi Purnomo</h4>
                                    <span>Documentation</span>
                                    <div class="social">
                                        <a href="https://www.instagram.com/andyformatika/"><i class="ri-instagram-fill"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
