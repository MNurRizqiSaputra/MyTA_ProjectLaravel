    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $jurusan->nama }}</td>
                <td>
                    <a href="{{ url('dashboard/jurusan/edit/' .$jurusan->id)}}" class="btn btn-warning rounded border-0">Edit</a>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{$jurusan->id}}">Delete</button>
                </td>
                <!-- Modal -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('jurusan.destroy', ['id' => $jurusan->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
